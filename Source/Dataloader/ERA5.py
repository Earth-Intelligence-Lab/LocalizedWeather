...
class ERA5(object):
    def __init__(self, lat_low, lat_up, lon_low, lon_up, year, region='Northeastern',
        ...
        self.file_path = self.data_path / 'ERA5' / 'Processed' / f'era5_{year}_{self.lon_low:.0f}_{self.lon_up:.0f}_{self.lat_low:.0f}_{self.lat_up:.0f}.nc'
    ...
    def load_ERA5_monthly(self, month, region):
        ...
        # data_path = self.data_path/f'ERA5/World/surface_{self.year}_{month}.nc'
        data_path = self.data_path / 'ERA5' / region / f'surface_{self.year}_{month}.nc'
